        ...
        <section class="content">
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
			  ...
			  ?>">
                <div class="box-header">
				  ...
				  <?php 
					...
					if($this->session->userdata('option')=='setting') echo 'fa-cog';
				    if($this->session->userdata('option')=='setting web') echo 'fa-globe';
					...
					if($this->session->userdata('option')=='wisata') echo 'fa-map-marker';
					if($this->session->userdata('option')=='event') echo 'fa-bullhorn';
					if($this->session->userdata('option')=='hotel') echo 'fa-building';
					if($this->session->userdata('option')=='fasilitas') echo 'fa-street-view';
				  ?> 
				  <?php
			  ...
			  ?>"></i>
                  <h3 class="box-title">
				  <?php if($this->session->userdata('option')=='wisata')
					       echo "Data Wisata Kuliner";
					    elseif($this->session->userdata('option')=='setting')
					       echo ucwords('setting admin');
					    elseif($this->session->userdata('option')=='setting web')
					       echo ucwords('setting website');
					    elseif($this->session->userdata('option')=='fasilitas')
					       echo ucwords('data fasilitas umum');
					    else
				           echo "Data ".ucwords($this->session->userdata('option'));
					    if($this->session->userdata('option')=='jenis')
				           echo ucwords(' wisata');?></h3>
                  <!-- tools box -->
